...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    public class TransferWillpower : TransferEffect
    {
        ...
        public override TextFile.Token[] SpellMakerDescription { get { return DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1552); } }
        public override TextFile.Token[] SpellBookDescription { get { return DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1252); } }
    }
}
