...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    public class DamageSpellPoints : BaseEntityEffect
    {
        ...
        public override string GroupName { get { return TextManager.Instance.GetLocalizedText("damage"); } }
        public override string SubGroupName { get { return TextManager.Instance.GetLocalizedText("spellPoints"); } }
        public override TextFile.Token[] SpellMakerDescription { get { return DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1514); } }
        public override TextFile.Token[] SpellBookDescription { get { return DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1214); } }
