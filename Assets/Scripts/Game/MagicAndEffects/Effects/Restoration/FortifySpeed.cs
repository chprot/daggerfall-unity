...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    public class FortifySpeed : FortifyEffect
    {
        ...
        public override TextFile.Token[] SpellMakerDescription { get { return DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1538); } }
        public override TextFile.Token[] SpellBookDescription { get { return DaggerfallUnity.Instance.TextProvider.GetRSCTokens(1238); } }
    }
}
